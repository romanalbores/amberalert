<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('id_tipo_asentamiento')); ?>:</b>
	<?php echo CHtml::encode($data->id_tipo_asentamiento); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('no_habitantes')); ?>:</b>
	<?php echo CHtml::encode($data->no_habitantes); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('estatus_asentamiento')); ?>:</b>
	<?php echo CHtml::encode($data->estatus_asentamiento); ?>
	<br />
