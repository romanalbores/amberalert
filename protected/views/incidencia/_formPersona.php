    ...
    <div class="accordion-group">
        ...
        <div id="collapseOne" class="accordion-body collapse">
            <div class="accordion-inner">
                ...
                <?php echo $form->textFieldRow($modelPersonaMenorCaracteristica, 'id_persona', array('class' => 'span5')); ?>
                ...
                <?php echo $form->textFieldRow($modelPersonaMenorCaracteristica, 'id_incidencia', array('class' => 'span5')); ?>
