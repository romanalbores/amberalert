...
class PersonaCaracteristica extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('raza, tez, color_piel, edad, idioma_primario, estatura, peso, cabello, ojos', 'length', 'max' => 100),
            ...
            array('id, id_persona, id_tipo_naturaleza, id_incidencia, raza, tez, color_piel, edad, idioma_primario, estatura, peso, cabello, ojos, complexion, caracteristicas_peculiares, herida, descripcion_herida, estatus, registrado_por, fecha_registro, modificado_por, fecha_modificado, eliminado', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('tez', $this->tez, true);
    ...
    public function obtenerListaPersonaCaracteristica() {
        $criteria = new CDbCriteria();
        $criteria->compare('estatus', 'ACTIVO');
        $criteria->compare('eliminado', 0);
    ...
    public function getByIdIncidencia($id_incidencia) {
        $criteria = new CDbCriteria;
        $criteria->condition = "estatus='ACTIVO' AND eliminado=0 AND id_incidencia=" . $id_incidencia;
        return $criteria;
    }

    public function getByIdTipoNaturaleza($id_tipo_naturaleza) {
        $criteria = new CDbCriteria;
        $criteria->condition = "estatus='ACTIVO' AND eliminado=0 AND id_tipo_naturaleza=" . $id_tipo_naturaleza;
        return $criteria;
    }
