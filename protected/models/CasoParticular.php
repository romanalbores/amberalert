...
/**
 * This is the model class for table "cata_caso_particular".
 *
 * The followings are the available columns in table 'cata_caso_particular':
 * @property integer $id
 ...
 */
class CasoParticular extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return CasoParticular the static model class
     */
    ...
    /**
     * Obtiene una lista de CasoParticular que no hayan sido eliminados
     * @return CasoParticular[]
     */
