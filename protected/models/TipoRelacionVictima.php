...
/**
 * This is the model class for table "cata_tipo_relacion_victima".
 *
 * The followings are the available columns in table 'cata_tipo_relacion_victima':
 * @property integer $id
 ...
 */
class TipoRelacionVictima extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return TipoRelacionVictima the static model class
     */
    ...
    public function tableName() {
        return 'cata_tipo_relacion_victima';
    }
    ...
    public function obtenerListaTipoRelacionVictima() {
        $criteria = new CDbCriteria();
        $criteria->compare('estatus', 'ACTIVO');
        $criteria->compare('eliminado', 0);
