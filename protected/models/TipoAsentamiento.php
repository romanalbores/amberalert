...
/**
 * This is the model class for table "cata_tipo_asentamiento".
 *
 * The followings are the available columns in table 'cata_tipo_asentamiento':
 * @property integer $id
