...
/**
 * This is the model class for table "cata_tipo_naturaleza".
 *
 * The followings are the available columns in table 'cata_tipo_naturaleza':
 * @property integer $id
 ...
 */
class TipoNaturaleza extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return TipoNaturaleza the static model class
     */
    ...
    public function obtenerListaTipoNaturaleza() {
        $criteria = new CDbCriteria();
        $criteria->compare('estatus', 'ACTIVO');
        $criteria->compare('eliminado', 0);
