...
/**
 * This is the model class for table "cata_zona".
 *
 * The followings are the available columns in table 'cata_zona':
 * @property integer $id
 ...
 * @property DataOficina $idOficina
 */
class Zona extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('id_oficina, nombre, registrado_por, fecha_registro, modificado_por, fecha_modificado', 'required'),
            array('id_oficina, registrado_por, modificado_por, eliminado', 'numerical', 'integerOnly' => true),
            ...
            array('id, id_oficina, nombre, nombre_corto, codigo, descripcion, estatus, registrado_por, fecha_registro, modificado_por, fecha_modificado, eliminado', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'idOficina' => array(self::BELONGS_TO, 'DataOficina', 'id_oficina'),
        );
    }
