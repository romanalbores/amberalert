...
/**
 * This is the model class for table "cata_organizacion".
 *
 * The followings are the available columns in table 'cata_organizacion':
 * @property integer $id
...
class Organizacion extends CActiveRecord {
    ...
    public function obtenerListaOrganizacion() {
        $criteria = new CDbCriteria();
        $criteria->compare('estatus', 'ACTIVO');
        $criteria->compare('eliminado', 0);
