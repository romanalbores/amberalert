...
/**
 * This is the model class for table "cata_tipo_poste".
 *
 * The followings are the available columns in table 'cata_tipo_poste':
 * @property integer $id
 ...
 */
class TipoPoste extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TipoPoste the static model class
	 */
