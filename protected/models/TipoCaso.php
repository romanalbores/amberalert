...
/**
 * This is the model class for table "cata_tipo_caso".
 *
 * The followings are the available columns in table 'cata_tipo_caso':
 * @property integer $id
 ...
 * @property CasoParticular[] $casoParticulars
 */
class TipoCaso extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'casoParticulars' => array(self::HAS_MANY, 'CasoParticular', 'id_tipo_caso'),
		);
	}
 ...
 $criteria->compare('estatus', 'ACTIVO');
        ...
        public function obtenerListaTipoCaso() {
        $criteria = new CDbCriteria();
        $criteria->compare('estatus', 'ACTIVO');
        $criteria->compare('eliminado', 0);
